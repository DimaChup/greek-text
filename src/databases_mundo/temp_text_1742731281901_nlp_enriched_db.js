// Enriched word frequency database for mundoADatabase
// Language: Spanish
// Generated on: 2025-03-23T12:48:20.161073
const mundoADatabase = {
  ...
  ierápetras: {
    ...
    morphology: 'proper name',
    meanings: [
      'Ierapetra (city in Crete)'
    ],
    bestTranslation: 'Ierapetra',
    lemma: 'ierápetras',
    LemmaMeanings: [
      'Ierapetra (city in Crete, Greece)'
    ]
  },
  apacible: {
    wordNumber: 132,
  ...
  asturiana: {
    ...
    LemmaMeanings: [
      'Asturian',
      'from Asturias',
      'relating to Asturias (region in Spain)'
    ]
  },
  villa: {
    wordNumber: 135,
